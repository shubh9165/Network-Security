...
class TrainingPipelineConfig:
    def __init__(self,timestemp=datetime.now()):
        timestemp=timestemp.strftime("%m_%d_%Y_%M_%H_%S")
...
#This is all data Ingestion  config
...
#This is all data validation  config
...
#This is all data transformation config
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.trained_model_file_path:str=os.path.join(self.model_trainer_dir_name,training_pipeline.MODEL_TRAINER_TRAINED_MODEL_DIR
                                            ,training_pipeline.MODEL_TRAINER_TRAINED_MODEL_FILE)
        self.expected_accuracy:float=training_pipeline.MODEL_TRAINER_EXPECTED_SCORE
        self.overfiting_underfiting_threshold:float=training_pipeline.MODEL_TRAINER_OVERFITING_UNDERFITING_THRESHOLD